      ...
      <main className={styles.main}>
        ...
        <section id="reports">
          ...
          <div className={styles.exportRow}>
            <button className={`${styles.exportBtn} ${styles.exportBtnPdf}`}>
            ...
            <button className={`${styles.exportBtn} ${styles.exportBtnExcel}`}>
              <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
                <rect x="2" y="1" width="12" height="14" rx="2" stroke="currentColor" strokeWidth="1.4" />
            ...
            <button className={`${styles.exportBtn} ${styles.exportBtnCsv}`}>
              <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
                <path d="M4 1h8a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V3a2 2 0 012-2z" stroke="currentColor" strokeWidth="1.4" />
