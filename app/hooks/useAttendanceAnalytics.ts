...
import type { GradeRow, GradeStat, DayTotal } from "../principal/attendance/components/attendanceline/types";
import { grades } from "../principal/attendance/components/attendanceline/constants";
