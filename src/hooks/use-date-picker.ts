...
export function useDatePicker({ selectedDate, onChange }: UseDatePickerProps) {
  ...
  return {
    ref, open, setOpen, viewYear, setViewYear, viewMonth, yearOptions,
    triggerLabel, footerLabel, shiftMonth, buildDays, selectDay, isSelected, isToday, goToday, clearSel,
  };
}
