import { AttendanceDay } from "@/app/(dashboard)/principal/attendance/_components/studentDrawer/studentDrawer.types";
import { PDF_STYLES } from "./studentDrawerPdf.styles";
import {
  getBarColor,
  getShortLabel,
  computeStats,
