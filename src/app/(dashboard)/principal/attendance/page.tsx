...
import { StudentAttendance } from "./_components/StudentAttendance";
import { DatePicker } from "@/components/ui/date-picker";
import { AttendanceOverlay } from "./_components/attendancetable/AttendanceOverlay";
import { StudentDrawer } from "./_components/studentDrawer/StudentDrawer";
import { STUDENTS, GRADE_ORDER, GRADE_SECTIONS, toDateStrFromDate } from "./_components/attendancetable/types";
    ...
    <div className={styles.pageContainer}>
      <div className={styles.pageHeader}>
        ...
        <div className={styles.headerActions}>
          ...
          <Button className={styles.actionSecondary} variant="outline" size="sm">Flag Absence</Button>
          <Button className={styles.actionSecondary} variant="outline" size="sm">New Tracker</Button>
          <Button className={styles.actionPrimary} variant="primary" size="sm">Add Record</Button>
        </div>
      </div>
